...
--lower-limit 0 \
--rigid \
'DEF:error=c2_h2_phoenix.rrd:error:MAX:start=1510521446:end=1510521506:step=1' \
'DEF:requests=c2_h2_phoenix.rrd:requests:MAX:start=1510521446:end=1510521506:step=1' \
'SHIFT:error:-51446' \
'SHIFT:requests:-51446' \
