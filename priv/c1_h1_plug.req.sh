...
--lower-limit 0 \
--rigid \
'DEF:error=c1_h1_plug.rrd:error:MAX:start=1510522513:end=1510522572:step=1' \
'DEF:requests=c1_h1_plug.rrd:requests:MAX:start=1510522513:end=1510522572:step=1' \
'SHIFT:error:-52513' \
'SHIFT:requests:-52513' \
